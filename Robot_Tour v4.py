...
def moveg(dist):
    ...
    # display.text("HELPPPPPPPPPPPPPPPPP", 0, 0)
    while travel < dist:
        if imu.gyro.data_ready():
            imu.gyro.read()
...
def turn(angle):
    ...
    kd = 4
    turn_rate = 0
    # 90 degrees isn't working perfectly so we might have to bump to 95
...
moves = ["m30.5", r, f, l, f, l, f, "t-180", f, l, "m100", "t180", f, r, "m100", l, f, r, f, l, f, "t180", "m150", "t180", "m100", l, f, l, "m100", r, "m51.5"]
